...
clear
bash <(curl -Ls https://raw.githubusercontent.com/ddheeraj888/script/main/auto_domain.sh)
clear
}
...
cat> /etc/issue.net << END
    ...
    <b>
        ...
        <font color="#FFFF00">𝓟𝓐𝓘𝓓 𝓢𝓒𝓡𝓘𝓟𝓣</font><br>
        <font color="#FF00FF">❖Ƭʜᴇ 𝓝𝓸 𝓓𝓓𝓞𝓢</font><br>
        <font color="#FF0000">❖Ƭʜᴇ 𝓝𝓸 𝓧𝓧𝓧</font><br>
        <font color="#FFB1C2">❖Ƭʜᴇ 𝓝𝓸 𝓑𝓟</font><br>
        <font color="#FFFFFF">❖Ƭʜᴇ 𝓝𝓸 𝓗𝓪𝓬𝓴𝓲𝓷𝓰</font><br>
        <font color="#00FF00">❖Ƭʜᴇ 𝓝𝓸 𝓟𝓞𝓡𝓝</font><br>
        <font color="#00FF00">
            ▄︻デ𝓓𝓝 𝓝𝓔𝓣𝓦𝓞𝓡𝓚══━一
        </font><br>
        <font color="#00FFE2">
        ...
        <font color="#FF00FF">✧ 𝓑𝓮𝓼𝓽 𝓲𝓷 𝓽𝓱𝓮 𝓜𝓪𝓻𝓴𝓮𝓽 ✧</font><br>
        <font color="#FFFF00">@𝓭𝓭𝓱𝓮𝓮𝓻𝓪𝓳64</font>
    </b>
</p>
END
cd
